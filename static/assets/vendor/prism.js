...
!function (e) {
    ...
    e.languages.csharp = e.languages.extend("clike", {
        ...
        e.languages.insertBefore("csharp", "class-name", {
            ...
            "defaults": {
                pattern: s("\\b(Int16|Int32|Int64|Math|Encoding|Thread|JsonSerializer|HttpServer|ListeningHost|HttpWebSocket|Console|File|Path)\\b", [x]),
                alias: "class-name"
            },
            "structs": {
                pattern: s("\\b(HttpStatusCode|AttributeTargets|Guid|RouteMethod|StringSplitOptions|DateTime|TimeSpan|ListeningPort)\\b", [x]),
                alias: "struct"
            },
            "interface": {
                pattern: s("\\b(ICollection|IDisposable|IRequestHandler|IEnumerable)\\b", [x]),
                alias: "interface"
            },
            "generic-method": {
